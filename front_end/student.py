...
class student:
    def __init__(self,root):
        ...
        title=Label(self.root,text='Student Management System',bd=10,relief=RIDGE,font=('arial',40,'bold'),bg='sky blue',fg='white')
        ...
        m_title=Label(Manage_frame,text='Manage Students',font=('arial',20,'bold'),bd=4, relief=GROOVE,bg='lavender')
        ...
        lbl_roll = Label(Manage_frame, text='Roll No:', font=('arial', 15, 'bold'), bd=4, relief=GROOVE, bg='lavender')
        lbl_roll.grid(row=2, column=0, padx=20, pady=10, sticky='w')

        txt_roll = Entry(Manage_frame,textvariable=self.Roll_No_var, font=('arial', 15, 'bold'), bd=4, relief=GROOVE)
...
#button
        ...
        Detail_frame.place(x=700, y=120, width=1200, height=850)
...
#table frame
        ...
        self.student_table=ttk.Treeview(Table_frame,columns=('Name','Roll No.','Email','Gender',"Contact No.",'DOB'),xscrollcommand=scroll_x.set,
        ...
        self.student_table.column('Name',width=163)
        self.student_table.column('Roll No.', width=163)
        self.student_table.column('Email', width=163)
        self.student_table.column('Gender', width=163)
        self.student_table.column('Contact No.', width=163)
        self.student_table.column('DOB', width=163)
    ...
    def search_data(self):
        ...
        if ans:
            ...
            query1 = "select * from student where Name=%s;"
            values1 = (ans,)
